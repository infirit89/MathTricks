...
namespace MathTricks
{
    ...
    partial class Input
    {
        ...
        public static Rectangle GetMouseRect() 
                            => new Rectangle(GetPosition(), new Point(_CursorSize, _CursorSize));
        ...
        public static bool IsButtonReleased(MouseButtons button) 
        {
            ...
            {
                case MouseButtons.Left:
                                    return _CurrMouseState.LeftButton == ButtonState.Released &&
                                            _PrevMouseState.LeftButton == ButtonState.Pressed;
                case MouseButtons.Middle:
                                    return _CurrMouseState.MiddleButton == ButtonState.Released &&
                                            _PrevMouseState.MiddleButton == ButtonState.Pressed;
                case MouseButtons.Right:
                                    return _CurrMouseState.RightButton == ButtonState.Released &&
